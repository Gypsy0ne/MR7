...
If any pump is activated during the cycle, sensors need ~20 seconds to stabilize their state. That's because the muxes are not seperated electrically. 
When sensors are in various moisture zones, they need time to calibrate before program starts (~40 seconds). This is not an issue when they are in similar moisture. ???*/
